        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Activity Description goes here. This is a detailed description of the activity, including rules, objectives, and any other relevant information.',
                style: TextStyle(
                  fontSize: 16,
                  color: AppColors.black.withAlpha(100),
                ),
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    '16-08-2023 09:30 PM',
                    style:
                        TextStyle(fontSize: 18, color: AppColors.primaryLight),
                  ),
                ],
              ),
            ),
