...
class ScheduledActivitiesFilterBottomSheet extends StatelessWidget
    with DeviceSizeUtil {
  const ScheduledActivitiesFilterBottomSheet({super.key});
        ...
        child: Column(
          children: [
            ...
            AppButton(
              buttonText: 'Apply',
              onPressed: () {
                controller.getScheduledActivities();
                Get.back();
              },
            ),
